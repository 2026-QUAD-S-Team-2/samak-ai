...
def _build_vision_prompt(maps_context: MapsContext | None = None) -> str:
    ...
    return (
        ...
        "[판단 제외 사항 - 아래 패턴은 사기 신호로 간주하지 말 것]\n"
        "- 'Fair chance', 'People with a criminal record are encouraged to apply', 'Felon friendly' 등의 문구: "
        "미국의 공정 채용(Fair Chance Hiring) 제도로, Indeed 등 정식 구인 플랫폼이 자동으로 표시하는 합법적 채용 정책임.\n\n"
        "[추가 추출 항목]\n"
